...
const iconSource = {
    Home: {
        active: require('~/assets/images/icons/ic_find_inactive.png'),
        inactive: require('~/assets/images/icons/ic_find_active.png'),
    },
    Find: {
        active: require('~/assets/images/icons/ic_home_inactive.png'),
        inactive: require('~/assets/images/icons/ic_home_active.png'),
    },
    Notification: {
        active: require('~/assets/images/icons/ic_message_inactive.png'),
        inactive: require('~/assets/images/icons/ic_message_active.png'),
    },
    Personage: {
        active: require('~/assets/images/icons/ic_mine_inactive.png'),
        inactive: require('~/assets/images/icons/ic_mine_active.png'),
    },
};
